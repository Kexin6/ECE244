...
private:
    ...
    //int printActive(TreeNode* ptr, int activeEntry) const;
    void printActive(TreeNode* ptr, int& activeEntry) const;
    void inorder(ostream& out, TreeNode* ptr) const;
    void delete_tree(TreeNode* ptr);
    TreeNode* removOne(TreeNode* ptr, string name, bool& result);
    TreeNode* findLeftMax(TreeNode* ptr);
